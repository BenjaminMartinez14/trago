        ...
        <div className="bg-trago-card border border-trago-border rounded-xl p-6">
          <form onSubmit={handleGenerateQR} className="flex gap-3 mb-6">
            ...
            <button
              ...
              className="px-4 py-2 bg-trago-orange hover:bg-trago-orange-light disabled:opacity-50 text-white font-semibold rounded-lg transition-colors text-sm shrink-0 press-scale"
            >
              Generar
            </button>
          </form>
          ...
          {qrSlug && (
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-trago-muted text-sm">{qrUrl}</p>
              <button
                onClick={handleDownloadQR}
                className="px-4 py-2 bg-trago-card hover:bg-trago-card-hover border border-trago-border text-white text-sm font-medium rounded-lg transition-colors flex items-center gap-2 press-scale"
              >
